...
# generator function test example
# def count_up_to():
...
#    count_res = list(count_up_to(2))
#    expected_res = [1,2,3]
#    assert count_res == expected_res
...
class TestInterleave:
    ...
    def test_floats(self):
        ...
        assert actual_res == pytest.approx(expected_res) # important to add when working with float point numbers
